...
plt.tight_layout()
plt.savefig("confusion_matrix_cancer_detection-PART2.png")
...
plt.savefig("model_training_accuracy-PART2.png")

# 10. Model explainability - pakiet shap
...
shap.summary_plot(
    ...
    show=False  # WAŻNE: nie pokazuj od razu, chcemy zapisać
)
