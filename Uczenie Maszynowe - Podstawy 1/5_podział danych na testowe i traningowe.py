"""Podziel dane na testowe i treningowe za pomocą funkcji train_test_split (uzyskaj obiekty X_train, X_test, y_train,
y_test) w proporcji 80%/20% i używając random_state=42.
W zbiorach zaczynających się od prefixu X_ powinny znajdować się cechy, na podstawie których będziemy prognozować cenę
domu (tzw. zmienne objaśniające, niezależne) natomiast w zbiorach zaczynających się od y_ powinna znajdować się zmienna
objaśniana (czyli w tym przypadku cena domów). """
