...
#
#
# # Po zakończeniu tuningu
# best_model = tuner.get_best_models(num_models=1)[0]
#
# # Tuner może zwrócić NIEPRZETRENOWANY model! (lub tylko częściowo)
# # Trzeba go jeszcze raz wytrenować ręcznie
# best_model.fit(X_train, y_train, epochs=3, validation_data=(X_val, y_val))  # lub więcej epok
# # Dopiero teraz zapisujemy gotowy, wytrenowany model
# best_model.save("best_model.h5")
#
...
best_model = keras.models.load_model("best_model.h5") # Load the pre-trained model
